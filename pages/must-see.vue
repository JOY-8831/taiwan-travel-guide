...
const onboardingSteps = [
  { text: "wish-card是可以點開來看的", target: "#first-wish-card", position: 'bottom' as const },
  { text: "愛心是可以點的，點完會幫你存起來", target: "#first-wish-card .heart-btn", position: 'bottom' as const }
]
...
onMounted(async () => {
    ...
    const guideDone = localStorage.getItem('onboarding_must_see_done')
    if (!guideDone) {
